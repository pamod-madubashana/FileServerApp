      ...
      <div className="flex-1 overflow-auto bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Player Settings Test</h1>
            <Button 
              variant="outline" 
              onClick={() => navigate("/")}
          ...
          <Card className="mb-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg rounded-xl">
            <CardHeader>
              <CardTitle className="text-2xl text-gray-900 dark:text-white">Player Settings Test</CardTitle>
            ...
            <CardContent className="space-y-6 py-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button variant="outline" onClick={handleNavigateToSettings}>Go to Settings</Button>
                </div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>Click "Go to Settings" to test the main settings page</li>
                  </ul>
                </div>
              </div>
            </CardContent>
